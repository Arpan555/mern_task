...
import {signup,signin,loginmemberusers,getsearch,addtask,gettasks,filtertasksearch,filtertask} from "./redux/actions/allActions"
...
export const requestgetfiltereddata=(state)=>{
    return async(dispatch)=>{
        try {
            ...
            const filterData=await request.get(`/filterdata?sdate=${sdate}&edate=${edate}`)
            console.log(filterData.data)
            dispatch(filtertask(filterData.data))
